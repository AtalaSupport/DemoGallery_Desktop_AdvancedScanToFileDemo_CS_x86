# AdvancedScanToFileDemo
This is a sample appliction for using Atalasoft DotImage Document Imaging
...
This is the C# version. We also have a [VB.NET version](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_AdvancedScanToFileDemo_VB_x86) available.  

NOTE that there is no x64 version. This is due to the vast majority of scanner 
drivers being native 32 bit.

Please see [FAQ: Common Problems with x64 TWAIN Scanning](https://www.atalasoft.(mailto:sales@atalasoft.com)/kb2/KB/50140/FAQ-Common-Problems-with-x64-TWAIN-Scanning) for more.


## Licensing
This demo assumes you have the Atalasoft DotImage SDK installed and licensed for DotImage Document Imaging as well as our PdfReader add-on.
...
- Browse for and install Atalasoft.DotImage.Pdf.x86. It will pull in the needed Pdf Encoding component. 
- Browse for and install Atalasoft.DotImage.PdfReader.x86. It will pull in the needed Pdf Decoding component. 


## Downloading source
The sources can be downloaded for [c#](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_AdvancedScanToFileDemo_CS_x86/archive/refs/heads/main.zip) and [VB.NET](https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_AdvancedScanToFileDemo_VB_x86/archive/refs/heads/main.zip)
...
```bash
git clone https://github.(mailto:sales@atalasoft.com)/AtalaSupport/DemoGallery_Desktop_AdvancedScanToFileDemo_CS_x86.git AdvancedScanToFileDemo
```
